 ...
 */
const BUILD = 'build 2026-06-18p (wand O = restore: on a robot it hands back a concrete test box — drop it back to run it; C is now an exact copy that keeps wildcards)';
